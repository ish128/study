...
operation::create-event[snippets='request-headers,request-fields,curl-request,http-request,http-response,response-headers,response-fields,links']
...
operation::query-event[snippets='curl-request,http-response,links']
